package com.jonathansilva.ui.player
{
	...
	public class Mp3Lite extends EventDispatcher
	{
		...
		private var musicArtisArray:Array = new Array();
		...
		*/
		public function Mp3Lite(_player)
		{
			mcPlayer = _player;
		}
		//---------- public functions ----------//
		...
		*/
		 ...
		 */
		public function setID3Info(artistName:TextField, noID3msg:String = "No ID3 Information"):void 
		{
			useID3Info = true;
			aName = artistName;
			sName = artistName;
			id3Msg = noID3msg;
			artistName.autoSize = TextFieldAutoSize.CENTER;
		}
		/**
		 ...
		 */
		public function setTimeInfo(buff:TextField):void
		{
			useTimeInfo = true;
			bufferInfo = buff;		
		}
		...
		private function xmlMP3Ok(e:Event):void
		{
			...
			for (var mp3Count:int = 0; mp3Count < xmlMP3Total; mp3Count++) 
			{
				...
				musicArtisArray.push(xmlMP3List[mp3Count].@artist);
			}
		...
		{			
			if (useTimeInfo) 
			{				
				openStream.isBuffering == true ? bufferInfo.text = "buffering..." : bufferInfo.text = musicArtisArray[idMP3] + " - " + musicNameArray[idMP3];				
			}
		}
		/**
		...
		{	
			if (usePlayList)
			{
				...
				var alturaMask:Number = mcPlayer.playListAnimation_mc.playList_mc.masker.height;
				var alturaContent:Number = mcPlayer.playListAnimation_mc.playList_mc.content.height;
				
				if(alturaMask >= alturaContent)
					mcPlayer.playListAnimation_mc.playList_mc.sb.visible = false;
